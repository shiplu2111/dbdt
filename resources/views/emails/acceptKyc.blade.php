                    ...
                    <tbody>
                     ...
                     <tr>
                      <td class="res-center" style="text-align: center;  color: white; font-family: 'Raleway', Arial, Sans-serif; font-size: 22px; letter-spacing: 0.7px; word-break: break-word; " data-color="M13 Title 1" data-size="M13 Title 1" data-max="32" data-min="12">
                       <img style="height: 100px" src="https://digitalbdt.org/front/assets/images/hm-banner-img-new.png" alt="" style="max-height: 100; max-width: 160;">
                      </td>
                     </tr>
                     <!-- title end -->
                     <tr>
                           ...
                           <tr>
                             <td>
                               <h4  style=" color: white; font-family: 'Nunito', Arial, Sans-serif; font-size: 14px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M13 Paragraph 1" data-size="M13 Paragraph 1" data-max="26" data-min="6">
                                ...
                                Hello,{{ $details['name'] }} ( {{ $details['email'] }} ),
                               </h4>
                             </td>
                            </tr>
                            <tr>
    ...
    <tr>
      <td>
        <p  style=" color: white; font-family: 'Nunito', Arial, Sans-serif; font-size: 14px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M13 Paragraph 1" data-size="M13 Paragraph 1" data-max="26" data-min="6">
          <h1>  Congratulation Your KYC Request Successfully Accepted. </h1>
    </p>
    </td>                    
