                ...
                <td>
                 <table width="600" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                    <tbody>
                     ...
                     <!-- title -->
                     <tr>
                      <td class="res-center" style="text-align: center; color: white; font-family: 'Raleway', Arial, Sans-serif; font-size: 22px; letter-spacing: 0.7px; word-break: break-word; " data-color="M13 Title 1" data-size="M13 Title 1" data-max="32" data-min="12">
                       <img src="https://digitalbdt.org/front/assets/images/hm-banner-img-new.png" alt="" style="max-height: 100; max-width: 160;">
                      </td>
                     </tr>
                     <!-- title end -->
                     <tr>
                     <td  class="res-center"  style="text-align: center; color: white; font-family: 'Raleway', Arial, Sans-serif; font-size: 22px; letter-spacing: 0.7px; word-break: break-word; ">Digital Blockchain Dominance Token</td>
                    </tr>
                     <tr>
                      ...
                      <td>
                       <table class="full" align="center" border="0" cellpadding="0" cellspacing="0">
                          <tbody>
                           <tr>
                             <td>
                               <h4  style=" color: white; font-family: 'Nunito', Arial, Sans-serif; font-size: 24px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M13 Paragraph 1" data-size="M13 Paragraph 1" data-max="26" data-min="6">
    ...
    <td>
      <p  style=" color: white; font-family: 'Nunito', Arial, Sans-serif; font-size: 14px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M13 Paragraph 1" data-size="M13 Paragraph 1" data-max="26" data-min="6">
    ...
    <td>
      <p  style=" color: white; font-family: 'Nunito', Arial, Sans-serif; font-size: 14px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M13 Paragraph 1" data-size="M13 Paragraph 1" data-max="26" data-min="6">
        Your single-use code is: <h2  style=" color: white; font-family: 'Nunito', Arial, Sans-serif;  letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M13 Paragraph 1" data-size="M13 Paragraph 1" data-max="26" data-min="6">7519214</h2>
      </p>
    </td>
    </tr> -->
    <!-- <tr>
    ...
    <tr>
      <td>
        <p  style=" color: white; font-family: 'Nunito', Arial, Sans-serif; font-size: 14px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M13 Paragraph 1" data-size="M13 Paragraph 1" data-max="26" data-min="6">
      If you didn't request this code, you can safely ignore this email. Someone else might have typed to withdraw dbdt from your account.
    </p>
    </td>                    
    ...
    <tr>
     ...
     <tr>
      <td>
        <p  style=" color: white; font-family: 'Nunito', Arial, Sans-serif; font-size: 18px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M13 Paragraph 1" data-size="M13 Paragraph 1" data-max="26" data-min="6">
          Thanks, <br>
          Digital BDT Team
        </p>
    </td>                    
