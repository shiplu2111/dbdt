...
<tr id="sid{{ $item->id }}">
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0)" onclick="acceptOrder({{ $item->id }})"
                                        class="btn  btn-sm btn-info"> Accept</a>
                                     <a href="javascript:void(0)" onclick="rejectOrder({{ $item->id }})"
                                        class="btn btn-sm btn-danger"> Reject</a> 
                                </td>
                            </tr>
                            @empty
    <tr>No Pending Request</tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
    ...
    <script>
        function rejectOrder(id){
            if(confirm("Do you want to Reject this deposit"))
            {
                $.ajax({
                    url:'/admin/pending/deposit/reject/'+id,
                    type:'GET',
                    data:{
                        _token: '{{ csrf_token() }}'
                    },
