                            ...
                            @foreach ($kyc_requests as $item)
                                <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
                                    <div class="card bg-light d-flex flex-fill">
                                        @if($item->id_verify_status==1)
                                        <div class="card-header text-muted border-bottom-0" style="background-color: blanchedalmond">
                                            @else
                                        <div class="card-header text-muted border-bottom-0"  style="background-color: rgb(240, 186, 105)">
@endif
