...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::to('backuser/plugins/sweetalert2/sweetalert2.min.css') }}">
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="wrapper" id="app">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            @php
                $kyc_needed = DB::table('users')
                    ->where('id_verify_status', 2)
                    ->count();
                $kyc_persons = DB::table('users')
                    ->where('id_verify_status', 2)
                    ->get();
                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right"  style="max-height: 412px; overflow-x: hidden; overflow-y: scroll">
                    ...
                    @forelse (auth()->user()->unreadNotifications as $item)
                        ...
                        <li style="background-color: #EFF4C3" onclick="add('{{ $item->id }}');">
                            <a href="{{ $item->data['admin_data']['url'] }}" class="dropdown-item">
                                <!-- Message Start -->
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p style="white-space: nowrap;  width: 200px;overflow: hidden;text-overflow: ellipsis; "
                                            class="text-sm"> {{ $item->data['admin_data']['result'] }}
                    ...
                    @foreach (auth()->user()->readNotifications as $items)
                        <li>
                            <a href="{{ $items->data['admin_data']['url'] }}" class="dropdown-item">
                                <!-- Message Start -->
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p style="white-space: nowrap;  width: 200px;overflow: hidden;text-overflow: ellipsis; "
                                            class="text-sm"> {{ $items->data['admin_data']['result'] }}
