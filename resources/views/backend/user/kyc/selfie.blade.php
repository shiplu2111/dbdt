    ...
    <div class="content-wrapper">
        ...
        <section>
            @if ($errors->any())
                                ...
                                @endif
            <form action="{{ route('selfie.submit') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="container">
                    <div class="row">
                        <div class="offset-md-3 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="dropzone-wrapper"  id="demo">
                                    ...
                                    <input required type="file" accept="image/*" id="passport_selfie" name="passport_selfie"
                                        class="dropzone">
...
<script>
    ...
    const input = document.getElementById('passport_selfie')
