                            ...
                            <div class="select-type-wrp">
                                <div class="input-type-radio-inr clearfix">
                                    ...
                                    <div class="register-form-inr box true">
                                        <form method="GET" onsubmit ="return verifyPassword()" class="needs-validation"
                                            action="{{ route('mastercard.stepThree') }}">
                                            @csrf
                                            ...
                                            <div class="tabs">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" name="username" placeholder="Username"  class="form-control" readonly value="{{ $m_email }}">

                                                </div>
                                                <div class="form-group">
                                                    <input type="password" name="password" id="password" placeholder="Enter password"
                                                    class="form-control"  required>
                                                    <span style="margin-left: 10px">  Minimum 8 digit</span>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <h6 style="margin-left: 10px">  ID details</h6>
<hr>
                                                <div class="form-group">
                                                    <label for="id_country">Issuing country of ID</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-5 form-group">
                                                        <label for="id_type">Issuing country of ID</label>
