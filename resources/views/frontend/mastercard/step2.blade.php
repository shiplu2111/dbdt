...
@section('content')
                    ...
                    @endif
                                    ...
                                    <div class="register-form-inr box true">
                                        <form method="GET" class="needs-validation"
                                            action="{{ route('mastercard.stepTwo') }}">
                                            @csrf
                                            <p>Please fill in the fields in English characters only</p>
                                            <div class="tabs">
                                                <div class="register-field" style="margin-bottom: 10px">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <textarea id="address" name="address" style="margin-bottom: 10px" class="form-control" rows="2" cols="50" placeholder="Present Address..." required></textarea>
                                                ...
                                                <div class="form-group">
                                                    <input type="tel" id="phone" name="phone" placeholder="Mobile number" class="form-control col-md-12" required>
    ...
    <script src="{{ URL::to('front/assets/build/js/intlTelInput.js') }}"></script>
